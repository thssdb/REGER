...
f=sns.lineplot(x='Order',y='Timestamp',linewidth = 3,data=df1[0:a+1],color="#3c78d8",dashes=False,ax=ax_arr[0][0])
sns.lineplot(x='Order',y='Timestamp',linewidth = 3,data=df1[a:b],color="#e31a1c",dashes=False,ax=ax_arr[0][0])
sns.lineplot(x='Order',y='Timestamp',linewidth = 3,data=df1[b-1:],color="#3c78d8",dashes=False,ax=ax_arr[0][0])
...
f=sns.lineplot(x='Order',y='Value',linewidth = 3,data=df2[0:a+1],color="#3c78d8",dashes=False,ax=ax_arr[0][1])
sns.lineplot(x='Order',y='Value',linewidth = 3,data=df2[a:b],color="#e31a1c",dashes=False,ax=ax_arr[0][1])
sns.lineplot(x='Order',y='Value',linewidth = 3,data=df2[b-1:],color="#3c78d8",dashes=False,ax=ax_arr[0][1])
#f.get_legend().remove()
f.tick_params(labelsize = 25)
f.xaxis.label.set_size(25)
f.yaxis.label.set_size(25)
...
f=sns.lineplot(x='Order',y='Timestamp_diff',linewidth = 3,data=df1[0:a+1],color="#3c78d8",dashes=False,ax=ax_arr[1][0])
sns.lineplot(x='Order',y='Timestamp_diff',linewidth = 3,data=df1[a:b],color="#e31a1c",dashes=False,ax=ax_arr[1][0])
sns.lineplot(x='Order',y='Timestamp_diff',linewidth = 3,data=df1[b-1:],color="#3c78d8",dashes=False,ax=ax_arr[1][0])
#f.get_legend().remove()
f.get_yaxis().get_major_formatter().set_scientific(False)
...
# print(df2)
f=sns.lineplot(x='Order',y='Value_diff',linewidth = 3,data=df2[0:a+1],color="#3c78d8",dashes=False,ax=ax_arr[1][1])
sns.lineplot(x='Order',y='Value_diff',linewidth = 3,data=df2[a:b],color="#e31a1c",dashes=False,ax=ax_arr[1][1])
sns.lineplot(x='Order',y='Value_diff',linewidth = 3,data=df2[b-1:],color="#3c78d8",dashes=False,ax=ax_arr[1][1])
#f.get_legend().remove()
f.tick_params(labelsize = 25)
f.xaxis.label.set_size(25)
f.yaxis.label.set_size(25)
...
f=sns.lineplot(x='Order',y='Timestamp_diff_width',linewidth = 3,data=df1[0:a+1],color="#3c78d8",dashes=False,ax=ax_arr[2][0])
sns.lineplot(x='Order',y='Timestamp_diff_width',linewidth = 3,data=df1[a:b],color="#e31a1c",dashes=False,ax=ax_arr[2][0])
sns.lineplot(x='Order',y='Timestamp_diff_width',linewidth = 3,data=df1[b-1:],color="#3c78d8",dashes=False,ax=ax_arr[2][0])
f.tick_params(labelsize = 25)
f.xaxis.label.set_size(25)
f.yaxis.label.set_size(25)
...
f=sns.lineplot(x='Order',y='Value_bit_width',linewidth = 3,data=df2[0:a+1],color="#3c78d8",dashes=False,ax=ax_arr[2][1])
sns.lineplot(x='Order',y='Value_bit_width',linewidth = 3,data=df2[a:b],color="#e31a1c",dashes=False,ax=ax_arr[2][1])
sns.lineplot(x='Order',y='Value_bit_width',linewidth = 3,data=df2[b-1:],color="#3c78d8",dashes=False,ax=ax_arr[2][1])
f.tick_params(labelsize = 25)
f.xaxis.label.set_size(25)
f.yaxis.label.set_size(25)
